...
<template>
  <!-- Colors: kbp, gray, red, green, yellow, blue, indigo, purple, pink -->
  <span
    :class="{
      'inline-flex items-center rounded-md px-1.5 py-0.5 text-xs font-medium ring-1 ring-inset': true,
      'bg-kbp-900 text-kbp-700 ring-kbp-600/10 dark:bg-kbp-400/10 dark:text-gray-400 dark:ring-gray-400/20': color === 'kbp',
